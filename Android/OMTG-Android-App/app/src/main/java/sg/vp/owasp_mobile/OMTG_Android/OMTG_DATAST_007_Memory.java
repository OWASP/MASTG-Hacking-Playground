...
public class OMTG_DATAST_007_Memory extends AppCompatActivity {

    // Tag can be used for logging
    String TAG = "OMTG_DATAST_007_Memory";
    String plainText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_omtg__datast_007__memory);
